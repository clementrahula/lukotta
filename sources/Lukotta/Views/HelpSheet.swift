            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    HelpSection(title: "Opening read-only") {
                        ...
                        Bullet(
                            "A drive that refuses to be written to is opened read-only rather than left closed"
                        )
                    }
                    ...
                    HelpSection(title: "Requirements") {
                        ...
                        Bullet(
                            "30 MB of RAM per open drive sitting idle, and up to 450 MB for one being copied to"
                        )
