...
#   LUKS2 -> LVM -> btrfs
#                  2024 identical, 0 differing, 0 missing   (copied in 65s)
#                  and the container opens every logical volume in it at once,
#                  all writable, concurrent copies into two byte-identical
